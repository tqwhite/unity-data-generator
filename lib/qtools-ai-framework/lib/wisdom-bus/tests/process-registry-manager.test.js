...
describe('process-registry-manager', () => {
    ...
    beforeEach(() => {
        ...
        registryManager = processRegistryManager({ logger: mockLogger });
    });
    ...
    describe('registerProcess()', () => {
        ...
        test('should log process registration', () => {
            ...
            expect(mockLogger.detail).toHaveBeenCalledWith(
                expect.stringContaining('Registered process: test-process')
            );
        });
        ...
        test('should handle duplicate registration gracefully', async () => {
            ...
            expect(mockLogger.warning).toHaveBeenCalledWith(
                expect.stringContaining('Re-registering process')
            );
        });
    });
