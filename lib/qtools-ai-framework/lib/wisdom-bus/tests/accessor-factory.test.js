...
describe('accessor-factory', () => {
    ...
    describe('create()', () => {
        test('should create accessor with unique processId', () => {
            ...
            expect(accessor.saveWisdom).toBeInstanceOf(Function);
            expect(accessor.getLatestWisdom).toBeInstanceOf(Function);
    ...
    describe('accessor.saveWisdom()', () => {
        ...
        test('should add value with namespaced key', () => {
            const result = accessor.saveWisdom('myKey', 'myValue');
        ...
        test('should handle complex values', () => {
            ...
            const result = accessor.saveWisdom('complex', complexValue);
        ...
        test('should handle errors gracefully', () => {
            ...
            const result = accessor.saveWisdom('errorKey', 'value');
    ...
    describe('accessor.getLatestWisdom()', () => {
        let accessor;
        const processId = 'test-proc-123';
        ...
        test('should check namespaced key first', () => {
            ...
            const result = accessor.getLatestWisdom('myKey');
        ...
        test('should fall back to initial wisdom', () => {
            ...
            const result = accessor.getLatestWisdom('existingKey');
        ...
        test('should record read operations', () => {
            ...
            accessor.getLatestWisdom('testKey');
        ...
        test('should return undefined for non-existent keys', () => {
            ...
            const result = accessor.getLatestWisdom('nonExistent');
    ...
    describe('process isolation', () => {
        test('should isolate data between different processes', () => {
            ...
            expect(accessor1.getLatestWisdom('shared')).toBe('value1');
            expect(accessor2.getLatestWisdom('shared')).toBe('value2');
        });
    });

    describe('backward compatibility', () => {
        test('should support old add() method', () => {
            const accessor = factory.create('test-proc');
            const result = accessor.add('key', 'value');
            
            expect(result.success).toBe(true);
            expect(result.namespacedKey).toBe('_proc_test-proc_key');
        });

        test('should support old get() method', () => {
            const accessor = factory.create('test-proc');
            mockStateManager.get.mockReturnValue('value');
            
            const result = accessor.get('key');
    ...
    describe('edge cases', () => {
        ...
        test('should handle empty string keys', () => {
            ...
            const result = accessor.saveWisdom('', 'emptyKeyValue');
        ...
        test('should handle very large values', () => {
            ...
            const result = accessor.saveWisdom('large', largeArray);
