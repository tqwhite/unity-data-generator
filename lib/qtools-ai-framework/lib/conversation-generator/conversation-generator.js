...
const moduleFunction = function (
	...
	const promptGeneratorPath = thoughtProcessConfig.promptGeneratorPath;
	...
	// Instantiate prompt-generator with promptLibraryName
	const promptGeneratorRequirePath = promptGeneratorPath || `${promptLibraryModulePath}/../synthDataThinkers/lib/prompt-generator`;
	const promptGenerator = require(promptGeneratorRequirePath)({
