		...
		return new Promise(async (resolve, reject) => {
			try {
				...
				const {
					...
					itemProcessorList,
					itemProcessorConversationName = 'unityGenerator', // Default for backward compatibility
					accumulator = 'object',
				...
				xLog.status(`${moduleName}: Using conversation '${itemProcessorConversationName}' for item processing`);
				const itemConversation = jinaCore.conversationGenerator({
					conversationName: itemProcessorConversationName,
					thinkerParameters,
					thoughtProcessName,
				});
