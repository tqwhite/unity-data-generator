...
const NAME_START_CHAR = 'A-Za-z:_\xC0-\xD6\xD8-\xF6\xF8-\u02FF\u0370-\u037D' + '\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF' + '\uF900-\uFDCF\uFDF0-\uFFFD';
...
const TAG_AND_POSITION = `(${TAG_NAME})\\[([\\d]+)\\]`; // Given a JSON document returned by xml2js (with _ and $ keys), return the
...
let extractAllProperties = _.partialRight(extractAll, findAllProperties); // Use find to search a JSON object.
//
// Parameters:
