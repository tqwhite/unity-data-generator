...
class RdfParser {
    ...
    parse(stream, options) {
        ...
        const context = new core_1.ActionContext(options)
            .setDefault(context_entries_1.KeysInitQuery.dataFactory, options.dataFactory || new rdf_data_factory_1.DataFactory());
...
RdfParser.CONTENT_MAPPINGS = mediaMappings_1.mediaMappings;
