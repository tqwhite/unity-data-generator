...
const commandLineParameters = commandLineParser.getParameters({
	applicationControls: ['-writeVectorDatabase', '-newDatabase', '--offset', '--limit', '--resultCount'],
});
...
const initAtp = require('qtools-ai-thought-processor/jina')({
	...
	applicationBasePath,
	applicationControls: ['-writeVectorDatabase', '-newDatabase', '--queryString', '--offset', '--limit', '--resultCount'],
